defmodule ExFinanceWeb.UserAuthTest do
  use ExFinanceWeb.ConnCase, async: true

  alias ExFinance.Accounts
  alias ExFinanceWeb.UserAuth
  alias Phoenix.LiveView
  import ExFinance.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      ...
      |> Map.replace!(
        :secret_key_base,
        ExFinanceWeb.Endpoint.config(:secret_key_base)
      )
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ExFinanceWeb.Endpoint.subscribe(live_socket_id)
