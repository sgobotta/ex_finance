defmodule ExFinanceWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      class={[
        ...
        @kind == :warn &&
          "bg-amber-50 text-amber-900 shadow-md ring-amber-500 fill-amber-900"
      ]}
      {@rest}
    >
      <p
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ExFinanceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ExFinanceWeb.Gettext, "errors", msg, opts)
    end
  end
